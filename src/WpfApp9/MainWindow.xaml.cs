...
namespace ComputerCompanyClasses
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private readonly ClientComponentUserControl clientComponentUserControl = new();
        private readonly ClientMainUserControl clientMainUserControl;
        private readonly ClientShoppingCartUserControl clientShoppingCartUserControl = new();
        private readonly ClientBuildUserControl clientBuildUserControl = new();
        private readonly ClientUpgradeUserControl clientUpgradeUserControl = new();

        private readonly ManagerDataBaseUserControl managerDataBaseUserControl = null!;
        private readonly AdminDataBaseUserControl adminDataBaseUserControl = null!;
        ...
        public MainWindow(Account account)
        {
            ...
            else
            {
                ...
                if (account.AccountType == "Admin" || account.AccountType == "Manager")
                {
                    ...
                    managerDataBaseUserControl = new();
                }
                if (account.AccountType == "Admin")
                {
                    EmployesSlot.Width = new GridLength(1, GridUnitType.Star);
                    adminDataBaseUserControl = new(activeAccount);
                }
            ...
            clientMainUserControl = new(toBuildingUserControl: Order_Click, toComponentUserControl: Components_Click, toUpgradeUserControl: Upgrade_Click);
            MainFrame.Navigate(clientMainUserControl);
        ...
        {
            MainFrame.Navigate(clientShoppingCartUserControl);
        }

        private void Upgrade_Click(object sender, RoutedEventArgs e)
        {
            MainFrame.Navigate(clientUpgradeUserControl);
        }

        private void Order_Click(object sender, RoutedEventArgs e)
        {
            MainFrame.Navigate(clientBuildUserControl);
        }

        private void Components_Click(object sender, RoutedEventArgs e)
        {
            MainFrame.Navigate(clientComponentUserControl);
        }

        private void DataBase_Click(object sender, RoutedEventArgs e)
        {
            MainFrame.Navigate(managerDataBaseUserControl);
        }

        private void Employers_Click(object sender, RoutedEventArgs e)
        {
            MainFrame.Navigate(adminDataBaseUserControl);
        }
